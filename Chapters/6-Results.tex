...
of the fitness distributions and descriptive statistics for various RGA populations
shows that the chromosomes are evolving. 

Results for the SGA chromosomes are presented next, even though
...
Finally, results for the TGA chromosomes are very briefly
...
without further evolution of the players. The players'
performance over the 50 trials is then analyzed to determine if players in later generations were
...
players, on average, the best player in the last generation will
...
significance level \(\alpha=0.01\) the null hypothesis is accepted for that
test and the conclusion is that the players from those two generations have the
same ability.
...
Where the null hypothesis is most often accepted is for populations with a
