...
and adjusts the sum by a factor \(\omega\). It then subtracts the expected
losses, which are adjusted by the factor \(1-\omega\).
...
\begin{enumerate}
  ...
  trade, the computer players would accept a trade that game a monopoly to the 
...
evenly weighted. Also, the trading theshold was lowered to 200/
...
A post competition discussion was also held with human players. The general 
...
threshold probably are better for trading parameters. Another reason for the
poor performance of the computer players could be that fixing the trading 
