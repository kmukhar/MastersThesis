...
did not compete in Round 1). These players played each other in 30 trials, 50
games per trial, and the table shows each player's average fitness over the 30
trials using Finish Order.
...
fitness evaluator produces better players than NM or TO.
...
fitness evaluator performs as well as the finish order player.
