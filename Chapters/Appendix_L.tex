\clearpage
\thispagestyle{empty}
\addcontentsline{toc}{chapter}{Appendix L: Creative Common License}
\setcounter{secnumdepth}{0}
\appendix{{\Large \bf Appendix L: Creative Common License}}
\label{sec:appendixL}
\\ \\
...
\\ \\
  ...
  \begin{enumerate} 
    ...
    made pursuant to Section 4(a), keep intact all copyright notices for the
    ...
    if a credit for all contributing authors of the Collective Work appears,
    ...
    \begin{enumerate} 
      \item {Performance Royalties Under Blanket Licenses. Licensor reserves the
      ...
      \item {Mechanical Rights and Statutory Royalties. Licensor reserves the
