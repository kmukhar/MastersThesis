...
lowest threshold. Following their lead, when we conducted the initial human
versus computer competitions, the trading threshold for the evolved AI players
was also set to 100. However, it appears that this threshold may have led
to poor performance of the RGA players during the human versus computer
competition. This is discussed in more detail in Sections~\ref{6_humanVRGA1} and
\ref{6_humanVRGA2}.
