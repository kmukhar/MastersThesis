...
Discuss Kotnik, Kalita here~\cite{kotnik2003significance}.

\begin{figure}[htp]
\centerline{\includegraphics[width=0.75\columnwidth]{Figures/figureTBD.png}}
\caption[Kotnik Kalita]{The significance of temporal-difference learning in
self-play training td-rummy versus evo-rummy.}
\label{figure-kotnik}
\end{figure}
